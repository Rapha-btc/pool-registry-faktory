// verify-mia-smart-negatives.js
// Error paths and the allowance-binding proof for mia-smart-faktory.
//
...
//
// Run: node verify-mia-smart-negatives.js
...
const OK = `${DEPLOYER}.mia-smart-faktory`;
const SABOTAGED = `${DEPLOYER}.mia-smart-tight`;
