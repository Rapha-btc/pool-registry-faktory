...
(define-read-only (get-dex-stx-token-liquidity (flag bool))
  (if flag
    ...
    (let (
        (wcorgi-pool (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.amm-pool-v2-01
          get-pool-details
          'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex
          'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wcorgi u100000000
        )))
        (stx-alex-pool (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.amm-pool-v2-01
          get-pool-details
...
(define-private (swap-stx-to-token
  ...
  (if flag
    ...
    (let ((token-8dec (try! (contract-call? ALEX-AMM swap-helper-a ALEX-WSTX ALEX-TOKEN ALEX-WCORGI
...
(define-private (swap-token-to-stx
  ...
  (if flag
    ...
    (let ((stx-8dec (try! (contract-call? ALEX-AMM swap-helper-a ALEX-WCORGI ALEX-TOKEN ALEX-WSTX
