;; cb92c53bf89af39e27fb0496fb7019b14872ef50ed07d2c4f38350d21f307883
;; testx402 Powered By Faktory.fun v1.0 
...
(define-fungible-token TESTX402 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? TESTX402 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance TESTX402 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? TESTX402 (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testx402-faktory-dex))
    (try! (ft-mint? TESTX402 (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testx402-pre-faktory))
