...
(define-public (arb-fak-bit-bit
  ...
  (begin
    (try! (contract-call?
      'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token transfer
      amt-in tx-sender current-contract none
    ))
    (let (
        (sbtc-out (try! (as-contract?
          ((with-ft
            'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token
            "welshcorgicoin" amt-in
          ))
      ...
      (try! (as-contract?
        ((with-ft 'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token
          "welshcorgicoin" amt-out
        ))
        (try! (contract-call?
          'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token
  ...
  (begin
    ...
    (let (
        (stx-out (try! (as-contract?
          ...
          (try! (swap-token-to-stx-bitflow amt-in))
        )))
...
(define-private (swap-token-to-stx-bitflow (amount uint))
  (let ((dy (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-core-v-1-2
      ...
      'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-pool-welsh-stx-v-1-1
      'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token
      'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.token-stx-v-1-2 amount u1
    ))))
    (ok dy)
  )
)
...
(define-private (swap-stx-to-token-alex (stx-amount uint))
  (let ((token-8dec (try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.amm-pool-v2-01
      swap-helper-a 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wstx-v2
      'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex
      'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wcorgi ALEX-FACTOR
      ALEX-FACTOR (* stx-amount u100) none
    ))))
    (ok (/ token-8dec u100))
  )
)
...
(define-private (swap-token-to-stx-alex (amount uint))
  (let ((stx-8dec (try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.amm-pool-v2-01
      swap-helper-a 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wcorgi
      'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex
      'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wstx-v2 ALEX-FACTOR
      ALEX-FACTOR (* amount u100) none
    ))))
    (ok (/ stx-8dec u100))
  )
)
...
(define-public (arb-fak-bit-alex
  ...
  (begin
    ...
    (let (
        ...
        (amt-out (try! (as-contract?
          ((with-stx stx-out) (with-ft 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex "alex"
            ALEX-PASSTHROUGH
          ) (with-ft 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wstx-v2
            "wstx" ALEX-PASSTHROUGH
          ) (with-ft 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wcorgi
            "wcorgi" ALEX-PASSTHROUGH
          ))
    ...
    (let (
        (stx-out (try! (as-contract?
          ((with-ft
            'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token
            "welshcorgicoin" amt-in
          ) (with-ft 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex "alex"
            ALEX-PASSTHROUGH
          ) (with-ft 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wstx-v2
            "wstx" ALEX-PASSTHROUGH
          ) (with-ft 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wcorgi
