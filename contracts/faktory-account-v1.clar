...
(define-constant OWNER 'SP2QGMXH21KFDX99PWNB7Z7WNQ92TWFAECEEK10GE) ;; 'SP3YT0XW92E6T2FE59B2G5N2WNNFSBZ6MZJRXVS7C) ;; owner (user/creator of account, full access)
(define-constant AGENT 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG) ;; 'SP3ZA8Z9DHHM612MYXNT96DJ3E1N7J04ZKP9105TG) ;; agent (can only take approved actions)

(define-read-only (get-configuration)
    (ok { account: (as-contract tx-sender),
          agent: AGENT,
          owner: OWNER })
)
