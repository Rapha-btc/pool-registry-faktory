// verify-pepe-smart-negatives.js
// Error paths and the allowance-binding proof for pepe-smart-faktory.
//
...
//
// Run: node verify-pepe-smart-negatives.js
...
const OK = `${DEPLOYER}.pepe-smart-faktory`;
const SABOTAGED = `${DEPLOYER}.pepe-smart-tight`;

const SBTC_HOLDER = "SP2C7BCAP2NH3EYWCCVHJ6K0DMZBXDFKQ56KR7QN2";
const STX_HOLDER = "SP9BP4PN74CNR5XT7CMAMBPA0GWC9HMB69HVVV51";
const MIA_HOLDER = "SP2022PJ05WB4VXP8HTVFAFE186AM94A4WYQ1RQY2"; // 100k PEPE

const SBTC_AMOUNT = 100000n;
const STX_AMOUNT = 100000000n;
const MIA_AMOUNT = 100000000n; // 100k PEPE
...
b.withSender(DEPLOYER).addContractDeploy({
  contract_name: "pepe-smart-tight",
  source_code: tight,
  clarity_version: ClarityVersion.Clarity5,
});
